...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`HR Management System v2`}</title>

        <meta
          name="description"
          content="HR Management System v2: Centralizing Employee Data, Payrolls, Time Tracking and Performance Evaluations. Empowering Employees, Payroll Office and Teamleads to manage and evaluate efficiently."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`HR Management System v2: Centralizing Employee Data, Payrolls, Time Tracking and Performance Evaluations. Empowering Employees, Payroll Office and Teamleads to manage and evaluate efficiently.`}
            </Text>
            <Box

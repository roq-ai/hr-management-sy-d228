...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'Employee Addition.create': { roles: ['owner', 'team-lead'], key: 'employee_addition', tenantPath: [], userPath: [] },
  'Payroll Processed.update': {
    roles: ['owner', 'hr-manager', 'employee', 'team-lead'],
